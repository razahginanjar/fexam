...
public class InvStockController extends BaseController {
    ...
    public ResponseEntity<InvStock> detail(@PathVariable Long stockId, @PathVariable String organizationId) {
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @DeleteMapping
    public ResponseEntity<?> remove(@RequestBody List<InvStock> invStocks, @PathVariable String organizationId) {
