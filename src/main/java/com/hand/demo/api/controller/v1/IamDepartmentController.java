...
public class IamDepartmentController extends BaseController {
    ...
    @GetMapping
    public ResponseEntity<Page<IamDepartment>> list(IamDepartment iamDepartment, @PathVariable Long organizationId, @ApiIgnore @SortDefault(value = IamDepartment.FIELD_DEPARTMENT_ID,
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @PostMapping
    public ResponseEntity<List<IamDepartment>> save(@PathVariable Long organizationId, @RequestBody List<IamDepartment> iamDepartments) {
        validList(iamDepartments);
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @DeleteMapping
    public ResponseEntity<?> remove(@RequestBody List<IamDepartment> iamDepartments, @PathVariable String organizationId) {
