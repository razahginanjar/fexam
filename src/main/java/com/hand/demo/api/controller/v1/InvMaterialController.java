...
public class InvMaterialController extends BaseController {
    ...
    @GetMapping
    public ResponseEntity<Page<InvMaterial>> list(InvMaterial invMaterial, @PathVariable Long organizationId, @ApiIgnore @SortDefault(value = InvMaterial.FIELD_MATERIAL_ID,
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @DeleteMapping
    public ResponseEntity<?> remove(@RequestBody List<InvMaterial> invMaterials, @PathVariable String organizationId) {
